...
switch($type)
{
    case 1: //Change account password
        ...
        {
            $data = password_hash($data, PASSWORD_BCRYPT, array('cost'=>10));
    ...
    case 3://Change account password
        ...
        if (mysqli_num_rows($check) == 0) {
            ...
            $data = password_hash($password, PASSWORD_BCRYPT, array('cost'=>10));
    ...
    case 5://Resent verification email
        ...
        if(!$user)
        {
            ...
            $body    = 'Hi ' . $name . '<br/>Your Account has been create, to sign in please verify your email.<br/> <br/> Please Click On This link or paste in your browser: <a href="' . $burl . 'Activation.php?code=' . $row['verify'] . '">' . $burl . 'Activation.php?=' . $row['verify']  . '</a> to activate  your account.';
            $headers = "From:" . $from . "\r\n";
            $headers .= "Reply-To: " . $from . "\r\n";
            $headers .= "MIME-Version: 1.0\r\n";
            $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
