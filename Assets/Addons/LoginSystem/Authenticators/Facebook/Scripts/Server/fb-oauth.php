                              ...
                              if (isset($code))
                                {
                                  ...
                                  if ($db->exec("INSERT INTO fbSessions (state, code) VALUES ('$state', '$code')"))
                                    {
                                     echo '<h6 class="MuiTypography-root Subheading upper center MuiTypography-subtitle1" style="margin-top: 50px;">Almost done!</h6>' .
                                     '<p class="MuiTypography-root Prompt center MuiTypography-body1">Close the window and return to the game.</p>' . 
                                     '<button class="MuiButtonBase-root MuiButton-root MuiButton-contained SubmitButton MuiButton-containedPrimary MuiButton-fullWidth" tabindex="0" type="submit" aria-label="continue-to-launcher" id="login-continue" style="margin-top: 20px;" onclick="self.close()"><span class="MuiButton-label">Continue</span></button>';
                                    }
                                  else
                                    {
