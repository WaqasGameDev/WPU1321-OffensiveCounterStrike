...
public class EnemyPlayer : MonoBehaviour {
	...
	PlayerController priorityTarget;
	List<PlayerController> myTargets;

	public event System.Action<PlayerController> OnTargetSelected;
	...
	private void Scanner_OnScanReady ()
	{
		...
		myTargets = playerScanner.ScanForTargets<PlayerController> ();
