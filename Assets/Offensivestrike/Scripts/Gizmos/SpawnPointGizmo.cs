...
public class SpawnPointGizmo : MonoBehaviour
{
    ...
    { 
		...
		if(!gameObject.name.StartsWith("TeamASpawn") && !gameObject.name.StartsWith("TeamBSpawn") && !gameObject.name.StartsWith("TeamANormal") && !gameObject.name.StartsWith("TeamBNormal"))
        {
        ...
        else
        {
			...
			if(gameObject.name.StartsWith("TeamANormal"))
			{
				Gizmos.color = GameSettings.teamAColor;
			}
			if(gameObject.name.StartsWith("TeamBNormal"))
			{
				Gizmos.color = GameSettings.teamBColor;
			}
		}
