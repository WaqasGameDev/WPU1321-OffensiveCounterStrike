...
public class LightningScript : MonoBehaviour {
	...
	void Update () {
		GameObject CameraMain = GameObject.Find (PlayerPrefs.GetString (playerNameJoinPrefsName) + "/FirstPersonView/Camera");
		if (CameraMain != null) {
			...
			gunCamera = CameraMain.GetComponent<Camera> ();
			...
			StopCoroutine (LightFlashOne ());
			StopCoroutine (FlashDelay ());
			StopCoroutine (LightFlashTwo ());
			StopCoroutine (Timer ());
		}
