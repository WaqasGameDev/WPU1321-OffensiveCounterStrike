...
public class StoreUI : MonoBehaviour
{
    ...
    public Button removedAdvertisementsButton;

    private void OnGUI()
    {
        //Purchase buttons.
        if (ADManager.instance.removedAdvertisements == false)
        {
            removedAdvertisementsButton.interactable = true;
        }
        else
        {
            removedAdvertisementsButton.interactable = false;
        }
    }
}