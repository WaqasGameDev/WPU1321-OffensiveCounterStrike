...
IL_03c7_1:
			{
				...
				L_164 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(37 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_163);
				V_20 = L_164;
				goto IL_03dc;
			}
		}// end try (depth: 1)
...
IL_009a_1:
			...
			}
			{
				...
				L_50 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(37 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_49);
				V_7 = L_50;
				goto IL_00be;
			}
		}// end try (depth: 1)
